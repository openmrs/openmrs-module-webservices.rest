 ...
 */
@Resource(name = RestConstants.VERSION_1 + "/allergy", order = 10, supportedClass = Allergy.class, supportedOpenmrsVersions = { "2.0.0" })
public class AllergyResource2_0 extends DataDelegatingCrudResource<Allergy> {
	...
	/**
	 * Annotated getter for allergen
	 * 
	 * @param allergy
	 * @return String Allergen
	 */
	@PropertyGetter("allergen")
	public static Allergen getAllergen(Allergy allergy) {
		if (allergy.getAllergen() == null)
			return null;
	...
	public void purge(Allergy delegate, RequestContext context)
		...
		// PatientService does not support purgeAllergy
	}
