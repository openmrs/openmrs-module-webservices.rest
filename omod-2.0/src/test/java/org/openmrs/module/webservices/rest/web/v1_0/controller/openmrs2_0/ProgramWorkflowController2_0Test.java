...
public class ProgramWorkflowController2_0Test extends MainResourceControllerTest {
	...
	public String getUuid() {
		return RestTestConstants1_9.WORKFLOW_UUID;
	}
	...
	public void shouldCreateWorkflow() throws Exception {
		String json =
				"{\"program\": \"" + RestTestConstants1_9.PROGRAM_UUID + "\",\"concept\": \"" + RestTestConstants1_9.CONCEPT3_UUID + "\"}";
		...
		assertEquals(RestTestConstants1_9.PROGRAM_UUID, createdWorkflow.getProgram().getUuid());
		assertEquals(RestTestConstants1_9.CONCEPT3_UUID, createdWorkflow.getConcept().getUuid());
	}
}
