...
public class PatientAllergyController2_0Test extends MainResourceControllerTest {
	...
	public void putAllergy_NonExistingPatient() throws Exception
	{
		String badPatientURI = "patient/badPatient/allergy";
		String json = "{}";
		handle(newPutRequest(getURI(), json));
	}
	
	@Test(expected = ObjectNotFoundException.class)
	public void putAllergy_ExistingPatientNonEmptyBody() throws Exception
	{
		String json = "{\"allergen\": {\"allergenType\":\"DRUG\", \"nonCodedAllergen\": \"test non coded\" }}";
		handle(newPutRequest(getURI(), json));
	}
	...
	@Test(expected = ObjectNotFoundException.class)
	public void putAllergy_ExistingPatientNonEmptyAllergies() throws Exception
	{
		String json = "{}";
		handle(newPutRequest(getURI(), json));
	}

	// put right patient, empty allergies	
	@Test
	public void putAllergy_ExistingPatientEmptyAllergies() throws Exception
	{
		Allergy allergy = Context.getPatientService().getAllergyByUuid(getUuid());
		Patient patient = allergy.getPatient();
