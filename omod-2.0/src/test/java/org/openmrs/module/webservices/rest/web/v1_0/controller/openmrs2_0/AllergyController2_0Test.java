...
@Ignore
// tests fail
// - required openmmrs-core version with merged allergyapi
// - missing org.openmrs.activelise.Problem
public class AllergyController2_0Test extends MainResourceControllerTest {
	...
	public void getAllergy_shouldGetADefaultRepresentationOfAnAllergy()
		...
		SimpleObject result = deserialize(handle(newGetRequest(getURI() + "/"
				+ RestTestConstants1_8.ALLERGY_UUID)));
		Assert.assertNotNull(result);
		Util.log("Allergy fetched (default)", result);
		Assert.assertEquals(RestTestConstants1_8.ALLERGY_UUID,
	...
	public void getAllergy_shouldGetAFullRepresentationOfAnAllergy()
		...
		MockHttpServletRequest req = newGetRequest(getURI() + "/"
				+ RestTestConstants1_8.ALLERGY_UUID, new Parameter(
	...
	public void voidAllergy_shouldVoidAnAllergy() throws Exception {
		...
		handle(newDeleteRequest(getURI() + "/"
				+ RestTestConstants1_8.ALLERGY_UUID, new Parameter("reason",
				"unit test")));
