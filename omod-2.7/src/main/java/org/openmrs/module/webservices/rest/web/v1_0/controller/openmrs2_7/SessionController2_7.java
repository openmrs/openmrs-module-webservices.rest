 ...
 */
@Controller("webservices.rest.sessionController2_7")
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + "/session")
public class SessionController2_7 extends BaseRestController {

    private static final Logger log = LoggerFactory.getLogger(SessionController2_7.class);
