...
public class PersonResource1_11Test extends BaseDelegatingResourceTest<PersonResource1_11, Person> {
    ...
    public void getAttributes_shouldReturnAllAttributes() throws Exception {
        PersonResource1_11 resource = getResource();

        List<PersonAttribute> attributes1 = (List<PersonAttribute>) PersonResource1_11.getAttributes(resource.getByUniqueId("df8ae447-6745-45be-b859-403241d9913c"));
        Assert.assertEquals(2, attributes1.size());

        List<PersonAttribute> attributes2 = (List<PersonAttribute>) PersonResource1_11.getAttributes(resource.getByUniqueId("341b4e41-790c-484f-b6ed-71dc8da222de"));
