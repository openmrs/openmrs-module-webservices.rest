...
public class PersonResource1_11 extends org.openmrs.module.webservices.rest.web.v1_0.resource.openmrs1_8.PersonResource1_8 {
	...
	public DelegatingResourceDescription getRepresentationDescription(Representation rep) {
		if (rep instanceof DefaultRepresentation) {
			...
			description.addProperty("deathdateEstimated", Representation.REF);
			return description;
		} else if (rep instanceof FullRepresentation) {
			DelegatingResourceDescription description = super.getRepresentationDescription(rep);
			description.addProperty("deathdateEstimated", Representation.DEFAULT);
			return description;
		}
		return null;
	}
