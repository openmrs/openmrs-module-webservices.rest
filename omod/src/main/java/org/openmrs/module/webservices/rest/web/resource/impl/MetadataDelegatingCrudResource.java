...
public abstract class MetadataDelegatingCrudResource<T extends OpenmrsMetadata> extends DelegatingCrudResource<T> {
	...
	/**
	 * @see BaseDelegatingConverter#getRepresentationDescription(Representation)
	 */
	@Override
	...
	/**
	 * @see DelegatingCrudResource#delete(String,
	 *      RequestContext)
	 */
	@Override
	...
	/**
	 * @see BaseDelegatingResource#undelete(Object,
	 *      RequestContext)
	 */
	@Override
