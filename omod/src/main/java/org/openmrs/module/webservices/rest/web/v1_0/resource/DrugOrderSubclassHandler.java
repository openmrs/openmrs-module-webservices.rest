...
/**
 * Exposes the {@link DrugOrder} subclass as a type in {@link OrderResource}
 */
@Handler(supports = DrugOrder.class)
public class DrugOrderSubclassHandler extends BaseDelegatingSubclassHandler<Order, DrugOrder> implements DelegatingSubclassHandler<Order, DrugOrder> {
	...
	/**
	 * Handles getOrdersByPatient for {@link OrderResource} when type=drugorder
	 * 
	 * @param patient
	 * @param context
	 * @return
