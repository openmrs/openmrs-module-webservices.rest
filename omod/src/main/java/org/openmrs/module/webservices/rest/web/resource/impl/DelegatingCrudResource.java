...
public abstract class DelegatingCrudResource<T> extends BaseDelegatingResource<T> implements CrudResource, Searchable, Listable {
	...
	/**
	 * @see org.openmrs.module.webservices.rest.web.resource.api.Retrievable#retrieve(String,
	 *      Representation)
	 */
	@Override
	...
	/**
	 * @see org.openmrs.module.webservices.rest.web.resource.api.Deletable#delete(String)
	 */
	@Override
	...
	/**
	 * @see org.openmrs.module.webservices.rest.web.resource.api.Deletable#undelete(String,
	 *      RequestContext)
	 */
	@Override
	...
	/**
	 * @see Searchable#search(RequestContext)
	 */
	@Override
	...
	/**
	 * @see Listable#getAll(RequestContext)
	 */
	@Override
