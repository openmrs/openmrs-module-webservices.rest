...
public abstract class DelegatingSubResource<T, P, PR extends DelegatingCrudResource<P>> extends BaseDelegatingResource<T> implements SubResource {
	...
	/**
	 * @see SubResource#create(String, SimpleObject, RequestContext)
	 */
	@Override
	...
	/**
	 * @see SubResource#retrieve(String, String, RequestContext)
	 */
	@Override
	...
	/**
	 * @see SubResource#update(String, String, SimpleObject, RequestContext)
	 */
	@Override
	...
	/**
	 * @see SubResource#purge(String, String, RequestContext)
	 */
	@Override
	...
	/**
	 * @see SubResource#getAll(String, RequestContext)
	 */
	@Override
	...
	/**
	 * @see SubResource#p[ut(String, SimpleObject, RequestContext)
	 */
	@Override
