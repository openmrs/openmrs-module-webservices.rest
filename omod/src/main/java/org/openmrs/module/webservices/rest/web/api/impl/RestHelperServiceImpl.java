...
public class RestHelperServiceImpl extends BaseOpenmrsService implements RestHelperService {
	...
	/**
	 * @see RestHelperService#getObjectByUuid(Class,
	 *      String)
	 */
	@Override
	...
	/**
	 * @see RestHelperService#getObjectById(Class,
	 *      Serializable)
	 */
	@Override
	...
	/**
	 * @see RestHelperService#getObjectsByFields(Class,
	 *      Field...)
	 */
	...
	/**
	 * @see RestHelperService#getPatients(Collection)
	 */
	@Override
	@SuppressWarnings("unchecked")
