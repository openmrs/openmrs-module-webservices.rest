 ...
 * Typically this will be used by implementations of {@link Searchable} that do not have a native query capable of doing a page-limited search
 * @param <T> the generic type of the list of results
 */
public class NeedsPaging<T> extends BaseSearchResult<T> {
