...
public abstract class BaseDelegatingSubclassHandler<Superclass, Subclass extends Superclass> implements DelegatingSubclassHandler<Superclass, Subclass> {
	 ...
	 * this handler
	 * 
	 * @see DelegatingSubclassHandler#getSuperclass()
	 */
	 ...
	 * handler
	 * 
	 * @see DelegatingSubclassHandler#getSubclassHandled()
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * @see DelegatingResourceHandler#getUpdatableProperties()
	 */
	@Override
	...
	/**
	 * @see DelegatingResourceHandler#purge(Object,
	 *      RequestContext)
	 */
	@Override
