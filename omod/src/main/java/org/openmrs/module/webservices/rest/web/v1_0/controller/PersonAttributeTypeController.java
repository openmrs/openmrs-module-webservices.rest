 ...
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + "/personattributetype")
public class PersonAttributeTypeController extends BaseCrudController<PersonAttributeTypeResource> {}
