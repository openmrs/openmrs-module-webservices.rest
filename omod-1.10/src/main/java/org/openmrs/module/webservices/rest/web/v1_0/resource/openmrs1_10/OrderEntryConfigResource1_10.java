...
@Resource(name = RestConstants.VERSION_1 + "/orderentryconfig", order = 90, supportedClass = Object.class, supportedOpenmrsVersions = {
		"1.10.*", "1.11.*", "1.12.*" })
public class OrderEntryConfigResource1_10 implements Listable {
	...
	public SimpleObject getAll(RequestContext context) throws ResponseException {
		...
		// try/catch each of these to avoid failing in the case where one of
		// these is not configured
		try {
			ret.put("drugRoutes",
