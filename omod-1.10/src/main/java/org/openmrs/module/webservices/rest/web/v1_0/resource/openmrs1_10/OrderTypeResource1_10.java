 ...
 */
@Resource(name = RestConstants.VERSION_1 + "/ordertype", supportedClass = OrderType.class, supportedOpenmrsVersions = "1.10.*")
public class OrderTypeResource1_10 extends MetadataDelegatingCrudResource<OrderType> {
    ...
    protected NeedsPaging<OrderType> doGetAll(RequestContext context) {
        return new NeedsPaging<OrderType>(Context.getOrderService().getOrderTypes(context.getIncludeAll()),
                context);
    }
