 ...
 */
@SubResource(parent = PersonResource1_9.class, path = "name", supportedClass = PersonName.class, supportedOpenmrsVersions = {
        "1.9.* - 1.12.*" })
public class PersonNameResource1_9 extends DelegatingSubResource<PersonName, Person, PersonResource1_9> {
