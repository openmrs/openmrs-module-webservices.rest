 ...
 */
public class CohortMember1_9 implements Serializable {
	
	public static final long serialVersionUID = 1L;
	
	private static final Log log = LogFactory.getLog(UserAndPassword1_9.class);
	 ...
	 * @param cohort
	 */
	public CohortMember1_9(Patient patient, Cohort cohort) {
		super();
