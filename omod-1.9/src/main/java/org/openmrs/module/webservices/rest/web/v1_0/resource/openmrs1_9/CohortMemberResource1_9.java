...
@SubResource(parent = CohortResource1_9.class, path = "member", supportedClass = CohortMember1_9.class, supportedOpenmrsVersions = {
        "1.9.* - 2.0.*" })
public class CohortMemberResource1_9 extends DelegatingSubResource<CohortMember1_9, Cohort, CohortResource1_9> {
	 ...
	 */
	@Override
	public NeedsPaging<CohortMember1_9> doGetAll(Cohort parent, RequestContext context) throws ResponseException {
		List<CohortMember1_9> members = new ArrayList<CohortMember1_9>();
		...
		return new NeedsPaging<CohortMember1_9>(members, context);
	}
