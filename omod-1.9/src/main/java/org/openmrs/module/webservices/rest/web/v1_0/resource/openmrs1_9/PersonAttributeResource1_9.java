 ...
 */
@SubResource(parent = PersonResource1_9.class, path = "attribute", supportedClass = PersonAttribute.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class PersonAttributeResource1_9 extends DelegatingSubResource<PersonAttribute, Person, PersonResource1_9> {
