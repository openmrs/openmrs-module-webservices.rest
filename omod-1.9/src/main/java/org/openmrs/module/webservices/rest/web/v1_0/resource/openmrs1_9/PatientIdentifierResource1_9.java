 ...
 */
@SubResource(parent = PatientResource1_9.class, path = "identifier", supportedClass = PatientIdentifier.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class PatientIdentifierResource1_9 extends DelegatingSubResource<PatientIdentifier, Patient, PatientResource1_9> {
