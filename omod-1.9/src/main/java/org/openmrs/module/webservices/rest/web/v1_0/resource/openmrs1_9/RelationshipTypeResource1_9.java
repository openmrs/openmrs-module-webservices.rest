...
@Resource(name = RestConstants.VERSION_1 + "/relationshiptype", supportedClass = RelationshipType.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class RelationshipTypeResource1_9 extends MetadataDelegatingCrudResource<RelationshipType> {
	
	public RelationshipTypeResource1_9() {
		super();
	...
	public String getDisplayAIsToB(RelationshipType delegate) {
	...
	public String getDisplayBIsToA(RelationshipType delegate) {
