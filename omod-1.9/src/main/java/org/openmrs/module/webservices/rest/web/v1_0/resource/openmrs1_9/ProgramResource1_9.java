...
@Resource(name = RestConstants.VERSION_1 + "/program", supportedClass = Program.class, supportedOpenmrsVersions = { "1.9.* - 1.10.*" }, order = 1)
public class ProgramResource1_9 extends MetadataDelegatingCrudResource<Program> {
