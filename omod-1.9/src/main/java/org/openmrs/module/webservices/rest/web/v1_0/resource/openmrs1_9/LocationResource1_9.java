...
@Resource(name = RestConstants.VERSION_1 + "/location", supportedClass = Location.class, supportedOpenmrsVersions = {
        "1.9.* - 1.12.*" })
public class LocationResource1_9 extends MetadataDelegatingCrudResource<Location> {
	...
	public Model getGETModel(Representation rep) {
		...
		if (rep instanceof DefaultRepresentation || rep instanceof FullRepresentation) {
			modelImpl.property("address1", new StringProperty()).property("address2", new StringProperty())
			        .property("cityVillage", new StringProperty()).property("stateProvince", new StringProperty())
			        .property("country", new StringProperty()).property("postalCode", new StringProperty())
			        .property("latitude", new StringProperty()).property("longitude", new StringProperty())
			        .property("countyDistrict", new StringProperty()).property("address3", new StringProperty())
			        .property("address4", new StringProperty()).property("address5", new StringProperty())
			        .property("address6", new StringProperty());
		}
		if (rep instanceof DefaultRepresentation) {
			modelImpl.property("tags", new ArrayProperty(new RefProperty("#/definitions/LocationtagGetRef")))
			...
			modelImpl.property("tags", new ArrayProperty(new RefProperty("#/definitions/LocationtagGet")))
	...
	public Model getCREATEModel(Representation rep) {
		return ((ModelImpl) super.getCREATEModel(rep)).property("address1", new StringProperty())
		        .property("address2", new StringProperty()).property("cityVillage", new StringProperty())
		        .property("stateProvince", new StringProperty()).property("country", new StringProperty())
		        .property("postalCode", new StringProperty()).property("latitude", new StringProperty())
		        .property("longitude", new StringProperty()).property("countyDistrict", new StringProperty())
		        .property("address3", new StringProperty()).property("address4", new StringProperty())
		        .property("address5", new StringProperty()).property("address6", new StringProperty())
		        .property("tags", new ArrayProperty(new StringProperty())).property("parentLocation", new StringProperty())
	...
	protected PageableResult doSearch(RequestContext context) {
		...
		if (locationsByTag == null) {
			...
			return new NeedsPaging<Location>((List<Location>) CollectionUtils.intersection(locationsByQuery, locationsByTag),
			        context);
		}
	}
