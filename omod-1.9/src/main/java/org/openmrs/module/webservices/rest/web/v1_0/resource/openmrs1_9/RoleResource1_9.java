 ...
 */
@Resource(name = RestConstants.VERSION_1 + "/role", supportedClass = Role.class, supportedOpenmrsVersions = { "1.9.* - 9.*" })
public class RoleResource1_9 extends MetadataDelegatingCrudResource<Role> {
