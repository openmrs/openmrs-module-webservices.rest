 ...
 */
@Resource(name = RestConstants.VERSION_1 + "/order", supportedClass = Order.class, supportedOpenmrsVersions = { "1.9.* - 1.9.*" }, order = 1)
public class OrderResource1_9 extends DataDelegatingCrudResource<Order> {
