 ...
 */
@Resource(name = RestConstants.VERSION_1 + "/drug", supportedClass = Drug.class, supportedOpenmrsVersions = { "1.9.* - 1.10.*" })
public class DrugResource1_9 extends MetadataDelegatingCrudResource<Drug> {
