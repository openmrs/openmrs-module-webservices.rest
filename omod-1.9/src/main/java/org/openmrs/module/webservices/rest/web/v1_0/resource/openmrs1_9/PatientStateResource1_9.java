 ...
 */
@SubResource(parent = ProgramEnrollmentResource1_9.class, path = "state", supportedClass = PatientState.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class PatientStateResource1_9 extends DelegatingSubResource<PatientState, PatientProgram, ProgramEnrollmentResource1_9> {
