...
/**
 * {@link Resource} for {@link IncomingHl7Message1_9}, supporting standard CRUD operations
 */
@Resource(name = RestConstants.VERSION_1 + "/hl7", supportedClass = IncomingHl7Message1_9.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class HL7MessageResource1_9 extends DataDelegatingCrudResource<IncomingHl7Message1_9> {
	 ...
	 */
	@Override
	protected void delete(IncomingHl7Message1_9 delegate, String reason, RequestContext context) throws ResponseException {
	 ...
	 */
	@Override
	public IncomingHl7Message1_9 getByUniqueId(String uniqueId) {
	 ...
	 */
	@Override
	public void setConvertedProperties(IncomingHl7Message1_9 delegate, Map<String, Object> propertyMap,
	 ...
	 */
	@Override
	public IncomingHl7Message1_9 newDelegate() {
		return new IncomingHl7Message1_9();
	}
	 ...
	 */
	@Override
	public void purge(IncomingHl7Message1_9 delegate, RequestContext context) throws ResponseException {
		throw new ResourceDoesNotSupportOperationException();
	}
	 ...
	 */
	@Override
	public IncomingHl7Message1_9 save(IncomingHl7Message1_9 delegate) {
		return new IncomingHl7Message1_9(Context.getHL7Service().saveHL7InQueue(delegate.toHL7InQueue()));
	}
	...
	public String getDisplayString(IncomingHl7Message1_9 message) {
