...
public class ProblemResource1_9 extends BaseActiveListItemResource1_9<Problem> {
	...
	public Model getGETModel(Representation rep) {
		...
		if (rep instanceof DefaultRepresentation || rep instanceof FullRepresentation) {
			model.property("modifier", new EnumProperty(ProblemModifier.class)).property("sortWeight", new DoubleProperty());
		}
	...
	public Model getCREATEModel(Representation rep) {
		return ((ModelImpl) super.getCREATEModel(rep)).property("problem", new RefProperty("#/definitions/ConceptCreate"))
		        .property("modifier", new EnumProperty(ProblemModifier.class)).property("sortWeight", new DoubleProperty())
