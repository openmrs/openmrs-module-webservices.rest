...
@SubResource(parent = ConceptResource1_9.class, path = "description", supportedClass = ConceptDescription.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class ConceptDescriptionResource1_9 extends DelegatingSubResource<ConceptDescription, Concept, ConceptResource1_9> {
	...
	public Model getCREATEModel(Representation representation) {
		return new ModelImpl().property("description", new StringProperty())
		        .property("locale", new StringProperty().example("fr")).required("description").required("locale");
	}
