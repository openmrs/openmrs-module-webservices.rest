...
@Resource(name = RestConstants.VERSION_1 + "/module", supportedClass = Module.class, supportedOpenmrsVersions = { "1.9.* - 9.*" })
public class ModuleResource1_9 extends BaseDelegatingReadableResource<Module> implements Uploadable {
	
	private ModuleFactoryWrapper moduleFactoryWrapper = new ModuleFactoryWrapper();
	
	private final String moduleActionLink = ModuleActionResource1_9.class.getAnnotation(Resource.class).name();
