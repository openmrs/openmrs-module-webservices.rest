...
@Component
public class FormSearchHandler1_9 implements SearchHandler {

	private final SearchConfig searchConfig = new SearchConfig("default", RestConstants.VERSION_1 + "/form", Collections.singletonList("1.9 - 9.*"),
