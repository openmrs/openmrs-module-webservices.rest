 ...
 */
@SubResource(path = "mapping", parent = EncounterResource1_9.class, supportedClass = EncounterProvider.class, supportedOpenmrsVersions = {"1.9.*", "1.10.*", "1.11.*", "1.12.*"})
public class EncounterProviderResource1_9 extends DelegatingSubResource<EncounterProvider, Encounter, EncounterResource1_9> {
    ...
    public String getDisplayString(EncounterProvider encounterProvider) {
        if (encounterProvider == null)
            return "";
        return encounterProvider.getProvider().getProviderId() + ": " + encounterProvider.getEncounterRole().getName();
    }
