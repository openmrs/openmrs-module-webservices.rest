 ...
 * EncounterProvider, supporting standard CRUD operations
 */
@SubResource(path = "encounterprovider", parent = EncounterResource1_9.class, order = 100, supportedClass = EncounterProvider.class, supportedOpenmrsVersions = {
		"1.9.*", "1.10.*", "1.11.*", "1.12.*" })
public class EncounterProviderResource1_9
		extends
		DelegatingSubResource<EncounterProvider, Encounter, EncounterResource1_9> {
	...
	@Override
	public PageableResult doGetAll(Encounter parent, RequestContext context)
			throws ResponseException {
		List<EncounterProvider> encounterProviders = new ArrayList<EncounterProvider>(
				parent.getEncounterProviders());
	...
	public EncounterProvider getByUniqueId(String uniqueId) {
		return Context.getService(RestHelperService.class).getObjectByUuid(
				EncounterProvider.class, uniqueId);
	}

	@Override
	protected void delete(EncounterProvider delegate, String reason,
			RequestContext context) throws ResponseException {
		delegate.getEncounter().removeProvider(delegate.getEncounterRole(),
	...
	@Override
	public void purge(EncounterProvider delegate, RequestContext context)
			throws ResponseException {
