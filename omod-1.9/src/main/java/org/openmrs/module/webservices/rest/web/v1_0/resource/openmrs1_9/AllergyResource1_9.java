...
@Resource(name = RestConstants.VERSION_1 + "/allergy", order = 100, supportedClass = Allergy.class, supportedOpenmrsVersions = {
		"1.9.*", "1.10.*", "1.11.*", "1.12.*" })
public class AllergyResource1_9 extends AllergyResource1_8 {
	...
	public static void setAllergen(Allergy allergy, Object value) {
		allergy.setAllergen(new ConceptResource1_9()
