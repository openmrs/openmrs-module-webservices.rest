...
@Resource(name = RestConstants.VERSION_1 + "/allergy", supportedClass = Allergy.class, supportedOpenmrsVersions = { "1.9.*",
        "1.10.* - 1.12.*" })
public class AllergyResource1_9 extends BaseActiveListItemResource1_9<Allergy> {
	...
	public Model getGETModel(Representation rep) {
		ModelImpl model = ((ModelImpl) super.getGETModel(rep)).property("allergyType", new EnumProperty(AllergyType.class))
		...
		if (rep instanceof FullRepresentation) {
			model.property("reaction", new RefProperty("#/definitions/ConceptGet")).property("allergen",
			    new RefProperty("#/definitions/ConceptGet"));
		}
		return model;
	}
	...
	public Model getCREATEModel(Representation rep) {
		return ((ModelImpl) super.getCREATEModel(rep)).property("allergyType", new EnumProperty(AllergyType.class))
		        .property("reaction", new ObjectProperty().property("uuid", new StringProperty()))
		        .property("severity", new EnumProperty(AllergySeverity.class)).property("allergen", new StringProperty());
	}
	...
	protected PageableResult doSearch(RequestContext context) {
		...
		if (patientUuid != null) {
			Patient patient = ((PatientResource1_9) Context.getService(RestService.class)
