...
@Resource(name = RestConstants.VERSION_1 + "/relationship", supportedClass = Relationship.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class RelationshipResource1_9 extends DataDelegatingCrudResource<Relationship> {
	...
	public Model getGETModel(Representation rep) {
		...
		if (rep instanceof DefaultRepresentation || rep instanceof FullRepresentation) {
			model.property("uuid", new StringProperty()).property("display", new StringProperty()).property("voided",
			    new BooleanProperty());
		}
		if (rep instanceof DefaultRepresentation) {
			model.property("personA", new RefProperty("#/definitions/PersonGetRef"))
			...
			model.property("personA", new RefProperty("#/definitions/PersonGet"))
	...
	public Model getCREATEModel(Representation rep) {
		ModelImpl model = new ModelImpl().property("personA", new StringProperty().example("uuid"))
		        .property("relationshipType", new StringProperty().example("uuid"))
		        .property("personB", new StringProperty().example("uuid")).property("startDate", new DateProperty())
		        .property("endDate", new DateProperty())
		        
		        .required("personA").required("relationshipType").required("personB");
		if (rep instanceof FullRepresentation) {
			model.property("personA", new RefProperty("#/definitions/PersonCreate"))
	...
	public Model getUPDATEModel(Representation rep) {
		return new ModelImpl().property("voided", new BooleanProperty()); //FIXME missing properties
	}
