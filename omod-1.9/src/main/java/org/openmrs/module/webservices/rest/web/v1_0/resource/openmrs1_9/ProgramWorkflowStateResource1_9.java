...
@SubResource(parent = ProgramWorkflowResource1_9.class, path = "state", supportedClass = ProgramWorkflowState.class, supportedOpenmrsVersions = {
        "1.9.* - 9.*" })
public class ProgramWorkflowStateResource1_9 extends DelegatingSubResource<ProgramWorkflowState, ProgramWorkflow, ProgramWorkflowResource1_9> {
