...
@Resource(name = RestConstants.VERSION_1 + "/obs", order = 2, supportedClass = Obs.class, supportedOpenmrsVersions = {
        "1.9.* - 1.10.*" })
public class ObsResource1_9 extends DataDelegatingCrudResource<Obs> implements Uploadable {
	 ...
	 * @throws ConversionException <strong>Should</strong> return uuid for foncept true
	 *             <strong>Should</strong> return uuid for concept false <strong>Should</strong>
	 *             throw exception on unexpected value <strong>Should</strong> return uuid for
	 *             primitive true <strong>Should</strong> return uuid for primitive false
	 */
	...
	public Object upload(MultipartFile file, RequestContext context) throws ResponseException, IOException {
		...
		return ConversionUtil.convertToRepresentation(obs, Representation.DEFAULT);
	}
