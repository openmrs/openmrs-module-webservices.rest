...
public class ChangePasswordController1_9Test extends RestControllerTestUtils {
	...
	public void updateUser_shouldUpdateTheUserPassword() throws Exception {
		User user = service.getUserByUuid(RestTestConstants1_9.USER_UUID);
		assertNotNull(user);
	...
	public void testUserChangeOtherUsersPassword() throws Exception {
		...
		MockHttpServletResponse response = handle(newPostRequest(PASSWORD_URI + "/" + RestTestConstants1_9.USER_UUID,
	...
	public void testUserChangeOtherUsersPasswordWithOutPrivilege() throws Exception {
		...
		handle(newPostRequest(PASSWORD_URI + "/" + RestTestConstants1_9.USER_UUID, "{\"newPassword\":\"" + newPassword
		        + "\"}"));
