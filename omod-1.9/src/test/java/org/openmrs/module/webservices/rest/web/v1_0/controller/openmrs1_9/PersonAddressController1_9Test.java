 ...
 */
public class PersonAddressController1_9Test extends MainResourceControllerTest {
	...
	public String getURI() {
		return "person" + "/" + RestTestConstants1_9.PERSON_UUID + "/address";
	}
	...
	public long getAllCount() {
		...
		Person person = service.getPersonByUuid(RestTestConstants1_9.PERSON_UUID);
	...
	public String getUuid() {
		return RestTestConstants1_9.PERSON_ADDRESS_UUID;
	}
	...
	public void shouldAddAnAddressToAPerson() throws Exception {
		int before = service.getPersonByUuid(RestTestConstants1_9.PERSON_UUID).getAddresses().size();
		...
		int after = service.getPersonByUuid(RestTestConstants1_9.PERSON_UUID).getAddresses().size();
	...
	public void shouldAddAnAddressWithSpecificUuidToAPerson() throws Exception {
		...
		PersonAddress personAddress = service.getPersonByUuid(RestTestConstants1_9.PERSON_UUID).getPersonAddress();
