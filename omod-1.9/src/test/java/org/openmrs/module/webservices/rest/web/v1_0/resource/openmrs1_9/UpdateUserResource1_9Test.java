 ...
 */
public class UpdateUserResource1_9Test extends BaseModuleWebContextSensitiveTest {
	
	private UserResource1_9 resource;
	
	@Before
	public void beforeEachTests() throws Exception {
		resource = (UserResource1_9) Context.getService(RestService.class).getResourceBySupportedClass(
		    UserAndPassword1_9.class);
	}
