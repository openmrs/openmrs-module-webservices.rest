...
public class FieldAnswerResource1_9Test extends BaseDelegatingResourceTest<FieldAnswerResource1_9, FieldAnswer> {
	...
	public FieldAnswer newObject() {
		Field field = Context.getFormService().getFieldByUuid(RestTestConstants1_9.FIELD_UUID);
		FieldAnswer fieldAnswer = new FieldAnswer();
		fieldAnswer.setConcept(Context.getConceptService().getConceptByUuid(RestTestConstants1_9.CONCEPT3_UUID));
