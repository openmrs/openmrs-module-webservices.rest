...
public class ProviderAttributeTypeControllerTest extends BaseCrudControllerTest {
	...
	public void updateProviderAttributeType_shouldChangeAPropertyOnAProviderAttributeType() throws Exception {
		...
		handle(newPostRequest(getURI() + "/" + Rest19ExtTestConstants.PROVIDER_ATTRIBUTE_TYPE_UUID, json));
