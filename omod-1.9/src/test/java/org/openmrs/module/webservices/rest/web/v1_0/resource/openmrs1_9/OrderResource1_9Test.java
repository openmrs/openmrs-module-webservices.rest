...
public class OrderResource1_9Test extends BaseDelegatingResourceTest<OrderResource1_9, Order> {
	...
	public String getUuidProperty() {
		return RestTestConstants1_9.ORDER_UUID;
	}
	...
	public void doGetAll_shouldReturnAllOrdersIncludingRetiredIfContextincludeAllIsSet() throws Exception {
		OrderResource1_9 or = getResource();
	...
	private void voidOneOrder() {
		Order order = Context.getOrderService().getOrderByUuid(RestTestConstants1_9.ORDER_UUID);
