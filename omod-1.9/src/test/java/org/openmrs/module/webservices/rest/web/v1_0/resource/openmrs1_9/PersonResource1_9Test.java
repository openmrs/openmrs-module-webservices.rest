...
public class PersonResource1_9Test extends BaseDelegatingResourceTest<PersonResource1_9, Person> {
	...
	public void getAttributes_shouldReturnAllAttributes() throws Exception {
		...
		List<PersonAttribute> attributes1 = PersonResource1_9.getAttributes(resource
		        .getByUniqueId("df8ae447-6745-45be-b859-403241d9913c"));
		Assert.assertEquals(2, attributes1.size());
		
		List<PersonAttribute> attributes2 = PersonResource1_9.getAttributes(resource
