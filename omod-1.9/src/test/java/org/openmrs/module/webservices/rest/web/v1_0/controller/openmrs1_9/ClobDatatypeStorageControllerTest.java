...
public class ClobDatatypeStorageControllerTest extends MainResourceControllerTest {
    ...
    public void shouldReturnClobDataAsFileByUuid() throws Exception{
        ClobDatatypeStorage clob =
                datatypeService.getClobDatatypeStorageByUuid(RestTestConstants1_9.CLOBDATATYPESTORAGE_RESOURCE_UUID);

        Assert.assertNotNull(clob);
        int size = clob.getValue().getBytes().length;
        MockHttpServletResponse response =
                handle(newGetRequest(getURI() + "/" + RestTestConstants1_9.CLOBDATATYPESTORAGE_RESOURCE_UUID));
    ...
    public void shouldDeleteAnExistingClobData() throws Exception{
        ...
        MockHttpServletResponse response =
                handle(newDeleteRequest(getURI() + "/" + RestTestConstants1_9.CLOBDATATYPESTORAGE_RESOURCE_UUID));
