...
public class ConceptMapController1_8Test extends MainResourceControllerTest {
	...
	public String getURI() {
		return "concept/" + RestTestConstants1_9.CONCEPT2_UUID + "/mapping";
	}
	...
	public long getAllCount() {
		return service.getConceptByUuid(RestTestConstants1_9.CONCEPT2_UUID).getConceptMappings().size();
	}
	...
	public void before() {
		...
		Concept concept = service.getConceptByUuid(RestTestConstants1_9.CONCEPT2_UUID);
	...
	public void shouldCreateConceptMap() throws Exception {
		String json = "{\"source\": \"" + RestTestConstants1_9.CONCEPT_SOURCE_UUID + "\", \"sourceCode\": \"test\"}";
		...
		assertThat(conceptMap.getConcept().getUuid(), is(RestTestConstants1_9.CONCEPT2_UUID));
		assertThat(conceptMap.getSource().getUuid(), is(RestTestConstants1_9.CONCEPT_SOURCE_UUID));
