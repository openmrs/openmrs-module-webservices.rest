 ...
 */
public class RelationshipTypeController1_9Test extends MainResourceControllerTest {
	...
	public String getUuid() {
		return RestTestConstants1_9.RELATIONSHIP_TYPE_UUID;
	}
	...
	public void shouldGetARelationshipTypeByName() throws Exception {
		...
		Assert.assertEquals(RestTestConstants1_9.RELATIONSHIP_TYPE_UUID, PropertyUtils.getProperty(result, "uuid"));
	...
	public void shouldEditARelationshipType() throws Exception {
		...
		RelationshipType updated = service.getRelationshipTypeByUuid(RestTestConstants1_9.RELATIONSHIP_TYPE_UUID);
	...
	public void shouldRetireARelationshipType() throws Exception {
		RelationshipType relationshipType = service.getRelationshipTypeByUuid(RestTestConstants1_9.RELATIONSHIP_TYPE_UUID);
		Assert.assertFalse(relationshipType.isRetired());
		handle(newDeleteRequest(getURI() + "/" + getUuid(), new Parameter("reason", "test reason")));
		relationshipType = service.getRelationshipTypeByUuid(RestTestConstants1_9.RELATIONSHIP_TYPE_UUID);
	...
	public void shouldSearchAndReturnAListOfRelationshipTypesMatchingTheQueryString() throws Exception {
		...
		Assert.assertEquals(RestTestConstants1_9.RELATIONSHIP_TYPE_UUID, PropertyUtils.getProperty(hits.get(0), "uuid"));
