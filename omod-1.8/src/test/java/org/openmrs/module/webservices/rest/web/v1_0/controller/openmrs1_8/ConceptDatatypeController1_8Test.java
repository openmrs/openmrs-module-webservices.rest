 ...
 */
public class ConceptDatatypeController1_8Test extends
	...
	public void shouldGetAConceptDatatypeByUuid() throws Exception {
		...
		ConceptDatatype conceptDataType = service
				.getConceptDatatypeByUuid(getUuid());
		Assert.assertEquals(conceptDataType.getUuid(),
				PropertyUtils.getProperty(result, "uuid"));
		Assert.assertEquals(conceptDataType.getName(),
				PropertyUtils.getProperty(result, "name"));
	}
	...
	public void shouldCreateAConceptDatatype() throws Exception {
		...
		Assert.assertNotNull(PropertyUtils.getProperty(newConceptDatatype,
				"uuid"));
