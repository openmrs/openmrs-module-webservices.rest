...
public class ObsController1_8Test extends MainResourceControllerTest {
	...
	public void getObs_shouldGetADefaultRepresentationOfAObs() throws Exception {
		SimpleObject result = deserialize(handle(newGetRequest(getURI() + "/"
				+ RestTestConstants1_8.OBS_UUID)));
		Assert.assertNotNull(result);
		Util.log("Obs fetched (default)", result);
		Assert.assertEquals(RestTestConstants1_8.OBS_UUID,
	...
	public void getObs_shouldGetAFullRepresentationOfAObs() throws Exception {
		MockHttpServletRequest req = newGetRequest(getURI() + "/"
				+ RestTestConstants1_8.OBS_UUID, new Parameter(
	 ...
	 */
	@Test
	public void getObsByPatientId_shouldGetADefaultRepresentationOfAllObs()
			throws Exception {
		MockHttpServletRequest req = newGetRequest(getURI(), new Parameter(
	...
	public void searchByEncounter_shouldGetObsInAnEncounter() throws Exception {
		MockHttpServletRequest req = newGetRequest(getURI(), new Parameter(
				"encounter", "6519d653-393b-4118-9c83-a3715b82d4ac"));
		SimpleObject result = deserialize(handle(req));
		List<Object> results = Util.getResultsList(result);
		Assert.assertEquals(2, results.size());
		List<Object> uuids = Arrays.asList(
				PropertyUtils.getProperty(results.get(0), "uuid"),
				PropertyUtils.getProperty(results.get(1), "uuid"));

		Assert.assertTrue(uuids
				.contains("39fb7f47-e80a-4056-9285-bd798be13c63"));
		Assert.assertTrue(uuids
				.contains("be48cdcb-6a76-47e3-9f2e-2635032f3a9a"));
	}
	 ...
	 */
	@Test
	public void createObs_shouldCreateANewObsWithNumericConcept()
			throws Exception {
	...
	public void voidObs_shouldVoidAObs() throws Exception {
		...
		handle(newDeleteRequest(getURI() + "/" + uuid, new Parameter("reason",
				"unit test")));
	...
	public void updateObs_shouldChangeAPropertyOnAnObs() throws Exception {
		...
		List<Obs> observations = Context.getObsService()
				.getObservationsByPersonAndConcept(oldObs.getPerson(),
						oldObs.getConcept());
	...
	@Test
	public void updateObs_shouldChangeAComplexPropertyOnAnObs()
			throws Exception {
	...
	public void purgeObs_shouldFailToPurgeAnObsWithDependentData()
			throws Exception {
		executeDataSet("org/openmrs/api/include/ObsServiceTest-complex.xml");
		handle(newDeleteRequest(getURI()
				+ "/9b6639b2-5785-4603-a364-075c2d61cd51", new Parameter(
				"purge", "")));
	}
	...
	@Test
	// @Ignore("RESTWS-238: Define creatable/updatable properties on Obs resource")
	public void createObs_shouldCreateAnObsWhenUnitsAreSpecifiedForAConceptNumeric()
			throws Exception {
	...
	/**
	 * @see ObsResource1_8#create(SimpleObject,
	 *      org.openmrs.module.webservices.rest.web.RequestContext)
	 * @throws Exception
	 */
	@Test(expected = ConversionException.class)
	public void createObs_shouldFailIfAnObsHasInvalidUnitsForAConceptNumeric()
			throws Exception {
	 ...
	 * @verifies get a dateTime obs value correctly represented as ISO8601 long
	 *           format
	 */
	@Test
	public void getObs_shouldGetADateObs() throws Exception {
		...
		Assert.assertEquals(ConversionUtil.convertToRepresentation(
				ymd.parse("2008-08-14"), Representation.DEFAULT), PropertyUtils
	...
	@Ignore
	// test failed
	public void setGroupMembers_shouldSetObservationGroupMembers()
			throws Exception {
		...
		String newObsUuid = PropertyUtils.getProperty(response, "uuid")
				.toString();
	...
	public void shouldGetObsByPatientAndConceptSet() throws Exception {
		...
		SimpleObject result = deserialize(handle(newGetRequest(getURI(),
				new Parameter("s", "default"), new Parameter("patient",
						"86526ed5-3c11-11de-a0ba-001e378eb67a"), new Parameter(
						"concept", "3f596de5-5caa-11e3-a4c0-0800271c1b75"))));
		Util.log("Obs fetched (default)", result);
	...
	public void shouldGetObsByPatient() throws Exception {
		...
		SimpleObject result = deserialize(handle(newGetRequest(
				getURI(),
				new Parameter("patient", "86526ed5-3c11-11de-a0ba-001e378eb67a"))));
	 ...
	 */
	@Test
	public void createObs_shouldCreateANewObsGroupWithMembers()
			throws Exception {
		List<Obs> observationsByPerson = Context.getObsService()
				.getObservationsByPerson(
						(Context.getPatientService().getPatient(7)));
		...
		// The next three obs must be children whose parent is the obs group
		// above
		Assert.assertEquals(obsGroup, observationsByPersonAfterSave.get(1)
				.getObsGroup());
		Assert.assertEquals(obsGroup, observationsByPersonAfterSave.get(2)
				.getObsGroup());
		Assert.assertEquals(obsGroup, observationsByPersonAfterSave.get(3)
				.getObsGroup());
	}
}
