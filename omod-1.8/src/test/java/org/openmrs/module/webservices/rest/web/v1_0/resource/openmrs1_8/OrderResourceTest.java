...
public class OrderResourceTest extends BaseDelegatingResourceTest<OrderResource, Order> {
	...
	/**
	 * @see OrderResource#doGetAll(RequestContext)
	...
	private void voidOneOrder() {
		Order order = Context.getOrderService().getOrderByUuid(ResourceTestConstants.ORDER_UUID);
