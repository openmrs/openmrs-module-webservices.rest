...
public class UserController1_8Test extends MainResourceControllerTest {
	...
	public void createUser_shouldCreateANewUserWithRoles() throws Exception {
		...
		user.add("person", "da7f524f-27ce-4bb2-86d6-6d1d05312bd5");
		user.add("roles",
				new String[] { "3480cb6d-c291-46c8-8d3a-96dc33d199fb" });
	 ...
	 */
	@Test
	public void getUser_shouldGetADefaultRepresentationOfAUser()
			throws Exception {
		...
		Assert.assertEquals(userName,
				PropertyUtils.getProperty(result, "username"));
	 ...
	 */
	@Test
	public void getUser_shouldGetAFullRepresentationOfAPatient()
			throws Exception {
		...
		Assert.assertNotNull(PropertyUtils
				.getProperty(result, "secretQuestion"));
		Assert.assertEquals("",
				PropertyUtils.getProperty(result, "secretQuestion"));
	}
	 ...
	 */
	@Test
	public void findUsers_shouldReturnNoResultsIfThereAreNoMatchingUsers()
			throws Exception {
