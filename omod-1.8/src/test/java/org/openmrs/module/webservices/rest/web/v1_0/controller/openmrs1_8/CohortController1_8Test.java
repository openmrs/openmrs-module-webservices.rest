...
public class CohortController1_8Test extends MainResourceControllerTest {
	...
	@Ignore
	// TODO - database changed between 1.8 to 1.9 - URGENCY is not nullable
	public void getCohort_shouldGetADefaultRepresentationInXML()
			throws Exception {
	...
	@Ignore
	// TODO - database changed between 1.8 to 1.9 - URGENCY is not nullable
	public void getCohortByExactName_shouldGetADefaultRepresentationOfACohort()
			throws Exception {
	...
	@Ignore
	// TODO - database changed between 1.8 to 1.9 - URGENCY is not nullable
	public void updateCohort_shouldFailToOverwriteMemberIdsOnACohort()
			throws Exception {
		Assert.assertEquals(3, service.getCohortByUuid(getUuid())
				.getMemberIds().size());
