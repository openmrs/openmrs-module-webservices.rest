...
public class HL7MessageController1_8Test extends MainResourceControllerTest {
	...
	@Ignore
	// TODO - database changed between 1.8 to 1.9 - URGENCY is not nullable
	public void enqueHl7Message_shouldEnqueueHl7InQueueMessageInPlainFormat()
			throws Exception {
	...
	@Ignore
	// TODO - database changed between 1.8 to 1.9 - URGENCY is not nullable
	public void enqueHl7Message_shouldEnqueueHl7InQueueMessageInJSONFormat()
			throws Exception {
		int before = service.getAllHL7InQueues().size();
	...
	public void adt_a28_shouldCreatePatient() throws Exception {
		...
		Assert.assertEquals((count + 1), Context.getPatientService()
				.getAllPatients().size());
	}
	...
	@Ignore
	// TODO - database changed between 1.8 to 1.9 - URGENCY is not nullable
	public void enqueHl7Message_shouldFailIfSourceDoesNotExist()
			throws Exception {
		SimpleObject hl7Message = new SimpleObject();
