...
public class PatientController1_8Test extends MainResourceControllerTest {
	...
	public void shouldCreateAPatient() throws Exception {
		...
		SimpleObject newPatient = deserialize(handle(newPostRequest(getURI(),
				json)));
	...
	@Test
	public void shouldSearchAndReturnAListOfPatientsMatchingTheQueryString()
			throws Exception {
		MockHttpServletRequest req = request(RequestMethod.GET, getURI());
	...
	@Test
	public void shouldMarkTheFirstIdentifierAsPreferredIfNoneMarked()
			throws Exception {
		...
		PatientIdentifier prefIdentifier = service.getPatientByUuid(uuid)
	...
	public void shouldFailIfThereAreMultiplePreferredIdentifiers()
			throws Exception {
		String uuid = "ba1b19c2-3ed6-4f63-b8c0-f762dc8d7562";
		String json = "{ \"person\": \""
				+ uuid
	...
	public void getCustomRepresentationDescription_shouldReturnDelegatingResourceDescription()
		...
		assertEquals(getUuid(), PropertyUtils.getProperty(
				Util.getResultsList(result).get(0), "uuid"));
		assertNotNull(PropertyUtils.getProperty(Util.getResultsList(result)
				.get(0), "identifiers"));
		assertNotNull(PropertyUtils.getProperty(Util.getResultsList(result)
				.get(0), "attributes"));
	}
