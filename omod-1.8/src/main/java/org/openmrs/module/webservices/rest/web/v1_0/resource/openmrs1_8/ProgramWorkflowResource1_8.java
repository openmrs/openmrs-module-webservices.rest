...
@Resource(name = RestConstants.VERSION_1 + "/workflow", supportedClass = ProgramWorkflow.class, supportedOpenmrsVersions = {
		"1.8.*, 1.9.*", "1.10.*", "1.11.*", "1.12.*" }, order = 200)
public class ProgramWorkflowResource1_8 extends
		MetadataDelegatingCrudResource<ProgramWorkflow> {
	...
	@Override
	public void purge(ProgramWorkflow delegate, RequestContext context)
