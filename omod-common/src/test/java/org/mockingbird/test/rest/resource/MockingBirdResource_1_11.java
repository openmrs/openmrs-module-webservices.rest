 ...
 */
@org.openmrs.module.webservices.rest.web.annotation.Resource(name = RestConstants.VERSION_1 + "/mockingbird", order = 1, supportedClass = MockingBird.class, supportedOpenmrsVersions = { "1.11.*" })
public class MockingBirdResource_1_11 extends MockingBirdResource_1_9 {
