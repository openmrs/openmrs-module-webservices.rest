 ...
 */
@org.openmrs.module.webservices.rest.web.annotation.Resource(name = RestConstants.VERSION_1 + "/mockingbird", order = 2, supportedClass = MockingBird.class, supportedOpenmrsVersions = { "1.9.*" })
public class DuplicateNameMockingBirdResource_1_9 implements Resource {
