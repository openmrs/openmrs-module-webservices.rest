 ...
 */
@org.openmrs.module.webservices.rest.web.annotation.Resource(name = RestConstants.VERSION_1 + "/animal", order = 1, supportedClass = IdentifiedAnimal.class, supportedOpenmrsVersions = {"2.4.*"})
public class AnimalResource_2_4 extends DelegatingCrudResource<Animal> {
