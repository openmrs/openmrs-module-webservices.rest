...
@SubResource(parent = ConceptResource1_8.class, path = "name", supportedClass = ConceptName.class)
public class ConceptNameResource extends DelegatingSubResource<ConceptName, Concept, ConceptResource1_8> {
