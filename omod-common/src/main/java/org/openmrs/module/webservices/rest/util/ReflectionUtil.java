...
public class ReflectionUtil {
	 ...
	 * with the given index from that interface, it inspects the class and all its direct
	 * superclasses and recursively calls itself
	 * 
	 * @should also inspect the superclasses
