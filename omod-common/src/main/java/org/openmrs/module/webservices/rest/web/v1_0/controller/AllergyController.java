...
/**
 * Controller for REST web service access to the Allergy resource. Supports CRUD on the resource itself.
 */
@Controller
...
public class AllergyController {
	 ...
	 * @param request
	 * @param response
	 * @return allergies for the given patient
	 * @throws ResponseException
	 */
	@RequestMapping(method = RequestMethod.GET, params = "patient")
	@WSDoc("Fetch all non-voided allergies for a patient with the given uuid")
	@ResponseBody
