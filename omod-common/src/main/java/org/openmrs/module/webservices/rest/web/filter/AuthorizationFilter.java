        ...
        if (request instanceof HttpServletRequest) {
            ...
            if (!Context.isAuthenticated()) {
                ...
                if (basicAuth != null) {
                    ...
                    HttpServletResponse httpResponse = (HttpServletResponse) response;
                    httpResponse.sendError(HttpServletResponse.SC_BAD_REQUEST, "Basic header does not have a provided credential");
                }
            } else {
                HttpServletResponse httpResponse = (HttpServletResponse) response;
                httpResponse.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Wrong credentials provided");
            }
        }
